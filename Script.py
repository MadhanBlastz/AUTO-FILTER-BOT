...
class script(object):
    START_TXT1 = """🅽🅾🆃🅴 : Hᴇʟʟᴏ {} ʏᴏᴜ ᴄᴀɴ ɢᴇᴛ ғʀᴇᴇ sᴜʙsᴄʀɪᴘᴛɪᴏɴ ʙʏ ʀᴇғᴇʀʀɪɴɢ ʏᴏᴜʀ ғʀɪᴇɴᴅs \n\n<u>Sᴜʙsᴄʀɪᴘᴛɪᴏɴ ʙᴇɴᴇғɪᴛ</u>:\nYᴏᴜ ᴄᴀɴ ɢᴇᴛ ᴀʟʟ ᴛʜᴇ ғɪʟᴇs ᴡɪᴛʜᴏᴜᴛ ᴀɴʏ Aᴅs 😇 </b>"""
    START_TXT2 = """<b><blockquote>Hᴇʟʟᴏ {}, Mʏ ɴᴀᴍᴇ ɪs <a href=https://t.me/{}>{}</a></blockquote>
I ᴄᴀɴ ᴘʀᴏᴠɪᴅᴇ ʙᴇsᴛ Qᴜᴀʟɪᴛʏ Mᴏᴠɪᴇs/WᴇʙSᴇʀɪᴇs/Aɴɪᴍᴇs ɪɴ <u>ᴛᴇʟᴜɢᴜ + Mᴜʟᴛɪ</u>ʙʏ ᴊᴜsᴛ ᴛʏᴘɪɴɢ ᴛʜᴇ ᴛɪᴛʟᴇ 😇 </b>"""
    HELP_TXT = """<b>Hᴇʏ {}
...
ʀᴇғᴇʀᴀʟ ʟɪɴᴋ - https://telegram.me/{}?start=Vi-{}
