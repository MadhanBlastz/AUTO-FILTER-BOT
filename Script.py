...
class script(object):
    START_TXT1 = """🅽🅾🆃🅴 Hᴇʟʟᴏ {} ʏᴏᴜ ᴄᴀɴ ɢᴇᴛ ғʀᴇᴇ sᴜʙsᴄʀɪᴘᴛɪᴏɴ ʙʏ ʀᴇғᴇʀʀɪɴɢ <u>3 ᴍᴇᴍʙᴇʀs</u> ᴏғ ʏᴏᴜʀ ғʀɪᴇɴᴅs \n\n<u>✨ Sᴜʙsᴄʀɪᴘᴛɪᴏɴ ʙᴇɴᴇғɪᴛs ✨</u>:\n• Aᴅs - ғʀᴇᴇ ᴇxᴘᴇʀɪᴇɴᴄᴇ /n• Sᴛʀᴇᴀᴍ ʟɪɴᴋ/n• Fᴀsᴛ ᴅᴏᴡɴʟᴏᴀᴅ ʟɪɴᴋ😇 </b>"""
    START_TXT2 = """<b><blockquote>Hᴇʟʟᴏ {}, Mʏ ɴᴀᴍᴇ ɪs <a href=https://t.me/{}>{}</a></blockquote>
I ᴄᴀɴ ᴘʀᴏᴠɪᴅᴇ ʟᴀᴛᴇsᴛ Mᴏᴠɪᴇs/WᴇʙSᴇʀɪᴇs/Aɴɪᴍᴇs ɪɴ <u>ᴛᴇʟᴜɢᴜ + Mᴜʟᴛɪ</u> ʙʏ ᴊᴜsᴛ ᴛʏᴘɪɴɢ ᴛʜᴇ ᴛɪᴛʟᴇ 😇 \n\n<u>✨ Gᴇᴛ Fʀᴇᴇ Sᴜʙsᴄʀɪᴘᴛɪᴏɴ ✨<\u> :\n•ʀᴇғᴇʀ ʏᴏᴜʀ ғʀɪᴇɴᴅs ᴛᴏ ɢᴇᴛ ғʀᴇᴇ sᴜʙsᴄʀɪᴘᴛɪᴏɴ\n• Iғ 3 ᴜɴɪǫᴜᴇ ᴜsᴇʀs sᴛᴀʀᴛ ᴛʜᴇ ʙᴏᴛ ᴡɪᴛʜ ʏᴏᴜʀ ʀᴇғᴇʀᴀʟ ᴛʜᴇɴ ʏᴏᴜ ᴡɪʟʟ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴀᴅᴅᴇᴅ ɪɴ ᴘʀᴇᴍɪᴜᴍ ʟɪsᴛ</b>"""
    HELP_TXT = """<b>Hᴇʏ {}
Hᴇʀᴇ Is Tʜᴇ Hᴇʟᴘ Fᴏʀ Mʏ Cᴏᴍᴍᴀɴᴅs.</b>"""

    SUBSCRIPTION_TXT = """<b>
ʀᴇғᴇʀʀ ʏᴏᴜʀ ʟɪɴᴋ ᴛᴏ ʏᴏᴜʀ ғʀɪᴇɴᴅs ᴛᴏ ɢᴇᴛ ғʀᴇᴇ ᴘʀᴇᴍɪᴜᴍ ғᴏʀ
...
ʙᴜʏ ᴘᴀɪᴅ ᴘʟᴀɴ ʙʏ - /plan</b>"""
    ...
    REFER_TXT = """
<b>ʀᴇғᴇʀʀ ʏᴏᴜʀ ʟɪɴᴋ ᴛᴏ ʏᴏᴜʀ ғʀɪᴇɴᴅs ᴛᴏ ɢᴇᴛ ғʀᴇᴇ ᴘʀᴇᴍɪᴜᴍ ғᴏʀ {}
